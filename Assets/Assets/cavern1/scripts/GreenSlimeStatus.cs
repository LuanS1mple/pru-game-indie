...
public class GreenSlimeStatus : MonoBehaviour
{
    [Header("Thông số cơ bản")]
    public string slimeName = "Green Slime";
    ...
    private GreenSlimeMovement slimeMovement;
    ...
    void Awake()
    {
        ...
        slimeMovement = GetComponent<GreenSlimeMovement>();
